...
CREATION_ABILITY_FIX: Dict[UnitTypeId, AbilityId] = {
    ...
    UnitTypeId.PARIAH: AbilityId.DISGUISEASVOLT_MATERIALIZEPARIAH,
    UnitTypeId.VOLT: AbilityId.DISGUISEASVOLT_MATERIALIZEVOLT,
    UnitTypeId.PULSAR: AbilityId.DISGUISEASVOLT_MATERIALIZEPULSAR,
    UnitTypeId.SUBJECTER: AbilityId.DISGUISEASVOLT_MATERIALIZESUBJECTER,
    UnitTypeId.CRUX: AbilityId.DISGUISEASVOLT_MATERIALIZECRUX,
    UnitTypeId.MYRIAD: AbilityId.DISGUISEASVOLT_MATERIALIZEMYRIAD,
    UnitTypeId.INDUCER: AbilityId.DISGUISEASVOLT_MATERIALIZEINDUCER,
    UnitTypeId.TITAN: AbilityId.DISGUISEASVOLT_MATERIALIZETITAN,
    UnitTypeId.WARD: AbilityId.DISGUISEASVOLT_MATERIALIZEWARD,
    UnitTypeId.UMBRA: AbilityId.DISGUISEASVOLT_MATERIALIZEUMBRA,
    UnitTypeId.AURORA: AbilityId.DISGUISEASVOLT_MATERIALIZEAURORA,
    UnitTypeId.ECHO: AbilityId.DISGUISEASVOLT_MATERIALIZEECHO,
    UnitTypeId.FUSE: AbilityId.DISGUISEASVOLT_MATERIALIZEFUSE,
    UnitTypeId.HARBINGER: AbilityId.DISGUISEASVOLT_MATERIALIZEHARBINGER,
    UnitTypeId.APERTURE: AbilityId.DISGUISEASVOLT_MATERIALIZEAPERTURE,
    UnitTypeId.GYRE: AbilityId.DISGUISEASVOLT_MATERIALIZEGYRE,
    UnitTypeId.PARAGON: AbilityId.DISGUISEASVOLT_MATERIALIZEPARAGON,
}
